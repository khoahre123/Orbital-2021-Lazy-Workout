...
public class SettingInstalledAppsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_setting_installed_apps);
...
//        appsView = findViewById(R.id.allInstalledApps);
        ...
        btn = findViewById(R.id.settingAllInstalledBtn);
        recyclerView = findViewById(R.id.settingAllInstalledView);
